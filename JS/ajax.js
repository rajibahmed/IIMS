...
Ajax.CheckReadyState = function(obj)
{
	...
	if(obj.readyState < 4) {
		...
		document.getElementById('loadingbox').innerHTML = '<table border=0 cellpadding=0 cellspacing=1 width=100 bgcolor="#000000"><tr><td align=center bgcolor="#ffffff" class=loading height="22px" style="font-family:verdana;font-size:12px"></td></tr></table>';
	}
	if( obj.readyState == 4 )
	{
		if(obj.status == 200)
