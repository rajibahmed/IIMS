...
$objRawItemList = new rawItem();
$RawListAll=$objRawItemList->retriveRawItem();
$rowRowListAll=count($RawListAll);
?>
...
?>
  <tr id ="stk_<?php echo $RawListAll["$i"]["stock_item_id"]?>" bgcolor="<?php echo $bgc;?>">
    <td><?php echo $RawListAll["$i"]["stock_item_name"];
				$stock_item_id = $RawListAll["$i"]["stock_item_id"];
				$stock_item_grp_id = $RawListAll["$i"]["stock_item_grp_id"];
    ...
    <td align="center"><a href="includes/contents/update/edit_raw_item.php?stc_itm_id=<?php echo $stock_item_id;?>&height=550&width=600" class="thickbox">Edit</a></td>
