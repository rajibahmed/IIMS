...
<form id="requisitionForm" name="requisitionForm" method="post" action="includes/model/requisition_action_save.php" >
  ...
  <div class="row_elements">
  		...
  		<select name='stock_section' class="stock_section_select " disabled >
			
		</select>	
		
  		<select name='stock_machine' class="stock_machine_select "  disabled >

		</select>	
		
 		<select name='stock_manufacturer' class="stock_manufacturer_select  " disabled >

		</select>

  		<select name='stock_machine_model' class="stock_machine_model_select  " disabled >

		</select>				
 

  		<select name='stock_part' class="stock_part_select " disabled >
		...
		<div class="mediumbody small_fonts">
            ...
            <div class="lowbannertest">	
				<ul>
					...
					<li style="width:110px" >Item Qty </li>
					<li style="width:100px" >Rate</li> 
					<li style="width:100px" >Value</li>
					<li>Remark</li>
				</ul>
			</div>
            <div class="lowbanner3"> </div>	
