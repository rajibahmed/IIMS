    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="26%" valign="middle"><input id="punit" type="text" name="unitRel1" />
            <p> </p></td>
        <td width="24%" valign="top"><select name="select2" id="select" class="unit" >
            <?php echo $unitName; ?>
          </select>
            </p></td>
...
<script type='text/javascript'>
	...
	$('.opQnty').blur(function(){
		...
		window.open('includes/contents/localtionOpQty.php?qty='+qty,'mywindow',		'width=700,height=200,top=300,left=300')
