...
<div id="test">
<form  id="CreateStockItem" name="CreateStockItem" method="post"   action="includes/model/general_item_actions.php"><table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td>Name</td>
    <td><input name="txtStkName" type="text" class="inventori_txtfield" id="txtStkName"></td>
  </tr>
  <tr>
    <td>Code</td>
    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td colspan="4" align="right" valign="top"><div align="center">
            <input name="btn_StkItem" type="submit" class="button saveButtonwidth" id="btn_StkItem" value="Save" />
          </div></td>
          </tr>
    </table></td>
  </tr>
