...
require_once("../lib/stock.class.php");
	...
	$Data = $Stock->retriveStockItembyGruopId($stock_group);
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="table5"><?php echo $Data[$i]['stock_received_qty']; ?></td>
    <td align="center" valign="middle" class="table5"><?php echo $Data[$i]['stock_issue_qty']; ?></td>
    <td align="center" valign="middle" class="table5"><?php echo $Data[$i]['stock_rejected_qty']; ?></td>
    <td align="center" valign="middle" class="table5"><?php echo $Data[$i]['stock_item_cl_balance']; ?></td>
    <td align="center" valign="middle" class="table5"><?php echo $Data[$i]['stock_item_unit_id']; ?></td>
    <td align="left" valign="middle" class="table5">&nbsp;</td>
    <td align="left" valign="middle" class="table6">&nbsp;</td>
  </tr> <?php } 
  ?>
  <tr>
    <td colspan="10" align="right" valign="middle" class="lastTable">Grand Total </td>
    <td align="left" valign="middle" class="lastTable">&nbsp;</td>
  </tr>
